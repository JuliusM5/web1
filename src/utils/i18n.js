...
const translations = {
  'en-US': {
   ...
   'photos.addPhotos': 'Add Photos',
    ...
    'external.tip3': 'Add translation tools specific to your destination',
  ...
  'es-ES': {
    ...
    'external.serviceUrl': 'URL o Referencia del Servicio',
    ...
    'external.tip1': 'Guarda confirmaciones de reserva para acceder fácilmente durante tu viaje',
    ...
    'external.noServices': 'Aún no hay servicios externos añadidos.',
  ...
  'fr-FR': {
    ...
    'external.selectType': 'Sélectionner le type',
    ...
    'external.serviceUrl': 'URL ou Référence du Service',
    ...
    'external.tip1': 'Enregistrez les confirmations de réservation pour y accéder facilement pendant votre voyage',
    'external.tip2': 'Liez à Google Maps personnalisés avec vos emplacements enregistrés',
