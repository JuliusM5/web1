...
function DealAlerts() {
  ...
  // This is the ONLY place where useNotification should be called
  ...
  const handleAddAlert = () => {
    ...
    if (!newAlert.origin || !newAlert.destination) {
      // Show error using the notification instance from above
      notification.show({
        type: 'error',
  ...
  // FIXED: Changed the function name and made sure it doesn't use hooks inside
  const notifyUserOfDeals = () => {
    // Use the notification object created at the component level
    notification.show({
      type: 'info',
      message: 'You will be notified of new deals!'
    });
  };
      ...
      <div>
        ...
        {alerts.length === 0 ? (
          <div className="bg-gray-50 p-4 rounded text-center">
            ...
            {/* CRITICAL FIX: Use the new function name */}
            <button
              onClick={notifyUserOfDeals}
