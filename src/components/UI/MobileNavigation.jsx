    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-40">
      <div className="grid grid-cols-5 h-16">
        ...
        >
          ...
          {showLabel && <span className="text-xs mt-1">Home</span>}
        </button>
        ...
        >
          ...
          {showLabel && <span className="text-xs mt-1">Trips</span>}
        </button>
        ...
        >
          ...
          {showLabel && <span className="text-xs mt-8 text-gray-600">New Trip</span>}
        </button>
        ...
        >
          ...
          {showLabel && <span className="text-xs mt-1">Templates</span>}
        </button>
        ...
        >
          ...
          {showLabel && <span className="text-xs mt-1">Settings</span>}
        </button>
      </div>
    </nav>
  );
